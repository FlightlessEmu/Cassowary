...
{
    // Mac Catalyst has no pthread_jit_write_protect_np, and its JIT pages stay
    // writable without it, so leave them alone there.
    #if defined(__APPLE__) && defined(__aarch64__) && !TARGET_OS_MACCATALYST
